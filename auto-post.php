...
require_once __DIR__ . '/includes/seo-regen.php';
require_once __DIR__ . '/includes/bulk-seo.php';
require_once __DIR__ . '/includes/images.php';
require_once __DIR__ . '/includes/content-language.php';
require_once __DIR__ . '/includes/generation-errors.php';
 ...
 * @return void
 */
function abcc_handle_api_request_error( $response, $api ) {
